const layout = {
  menuTree: [
    ...
    //   label: '组件',
    //   children: [
        { label:'加载【loading-page】',prop:'加载组件',page:'loading',icon:'el-icon-loading'},
        { label:'文档【doc】',prop:'文档组件',page:'doc',icon:'el-icon-reading'},
        { label:'菜单树【menu-tree】',prop:'菜单树',page:'menu-tree',icon:'el-icon-copy-document'},
